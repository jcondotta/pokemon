...
class TopExperiencedPokemonControllerIT {
    ...
    private static final List<Pokemon> sortedTestPokemonByExperience = Arrays.stream(TestPokemon.values())
    ...
    void beforeEach(@LocalServerPort int port) {
        requestSpecification = RestAssured.given()
                ...
                .basePath(PokemonAPIPath.POKEMON_TOP_EXPERIENCED)
    ...
    @Test
    void shouldReturnTop5ExperiencedPokemon_whenValidRequest() {
        var response = given()
        ...
        var expectedTop5Names = sortedTestPokemonByExperience.stream()
                .limit(DEFAULT_TOP_N)
                .map(Pokemon::name)
                .toList();
    ...
    @Test
    void shouldReturnTopNExperiencedPokemon_whenTopNIsProvided() {
        int customTopN = 3;
        ...
        var expectedTopNNames = sortedTestPokemonByExperience.stream()
                .limit(customTopN)
                .map(Pokemon::name)
                .toList();
