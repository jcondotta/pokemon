...
class TopTallestPokemonControllerIT {
    ...
    private static final List<Pokemon> sortedTestPokemonByHeight = Arrays.stream(TestPokemon.values())
    ...
    @Test
    void shouldReturnTop5TallestPokemon_whenValidRequest() {
        var response = given()
        ...
        var expectedTop5Names = sortedTestPokemonByHeight.stream()
                .limit(DEFAULT_TOP_N)
                .map(Pokemon::name)
                .toList();
    ...
    @Test
    void shouldReturnTopNTallestPokemon_whenTopNIsProvided() {
        int customTopN = 3;
        ...
        var expectedTopNNames = sortedTestPokemonByHeight.stream()
                .limit(customTopN)
                .map(Pokemon::name)
                .toList();
